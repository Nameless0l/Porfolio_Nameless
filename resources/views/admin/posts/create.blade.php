...
@section('header', 'Ajouter un article')
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="excerpt" id="excerpt" rows="3"
                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('excerpt') }}</textarea>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <textarea id="editor" name="body" rows="20"
                            class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('body') }}</textarea>
                    </div>
                    @error('body')
