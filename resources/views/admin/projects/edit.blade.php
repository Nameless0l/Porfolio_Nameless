...
@section('header', 'Modifier un projet')
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="type" id="type"
                        ...
                        <option value="personal" {{ old('type', $project->type) == 'personal' ? 'selected' : '' }}>Personnel</option>
                        <option value="professional" {{ old('type', $project->type) == 'professional' ? 'selected' : '' }}>Professionnel</option>
                        <option value="academic" {{ old('type', $project->type) == 'academic' ? 'selected' : '' }}>Académique</option>
                    </select>
                    @error('type')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    ...
                    <div class="mt-4">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="is_featured" name="is_featured" type="checkbox" value="1" {{ old('is_featured', $project->is_featured) ? 'checked' : '' }}
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="long_description" id="long_description" rows="6"
                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('long_description', $project->long_description) }}</textarea>
