...
@section('header', 'Modifier une expérience')
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="type" id="type"
                        ...
                        @foreach($types as $key => $value)
                            <option value="{{ $key }}" {{ old('type', $experience->type) == $key ? 'selected' : '' }}>{{ $value }}</option>
                        @endforeach
                    </select>
                    @error('type')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <div class="flex items-center">
                            <input id="is_current" name="is_current" type="checkbox" value="1" {{ old('is_current', $experience->is_current) ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" onclick="document.getElementById('end_date').disabled = this.checked;">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('description', $experience->description) }}</textarea>
